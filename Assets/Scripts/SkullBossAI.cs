...
public class SkullBossAI : MonoBehaviour
{
    ...
    IEnumerator TriggerTransformation() {
        ...
        moveEnemy2 = true;
        tempEnemy2.transform.localScale = new Vector3(0.5f,0.5f,0.5f);
        yield return new WaitForSeconds(2f);
        Destroy(tempEnemy1);
        transform.localScale += scaleChange;
        gameObject.GetComponent<AudioSource>().Play();
        ...
        moveEnemy3 = true;
        tempEnemy3.transform.localScale = new Vector3(0.5f,0.5f,0.5f);
        yield return new WaitForSeconds(2f);
        Destroy(tempEnemy2);
        transform.localScale += scaleChange;
        gameObject.GetComponent<AudioSource>().Play();
        ...
        moveEnemy4 = true;
        tempEnemy4.transform.localScale = new Vector3(0.5f,0.5f,0.5f);
        yield return new WaitForSeconds(2f);
        Destroy(tempEnemy3);
        transform.localScale += scaleChange;
        gameObject.GetComponent<AudioSource>().Play();
